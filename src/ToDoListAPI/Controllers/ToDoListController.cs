...
namespace ToDoListAPI.Controllers
{
    ...
    public class ToDoListController : ApiController
    {
        ...
        private static ToDoListDataAPI20170629120627 NewDataAPIClient()
        {
            var client = new ToDoListDataAPI20170629120627(new Uri(ConfigurationManager.AppSettings["toDoListDataAPIURL"]));
